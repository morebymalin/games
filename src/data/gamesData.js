...
export const escapeGames = [
...

  {
    ...
    rooms: [
       ...
       { id: 2, name: "Krig", img: "/escape/sverigeshistoria/krig.jpg", "type": "symbols", "allowedSymbols": ["circle", "cross", "star", "heart", "triangle", "rectangle", "cloud"], "answerSequence": ["circle", "star", "cloud", "triangle", "rectangle", "heart", "cross"], instruction: "Bra jobbat! Ta ledtråd 7" },
       { id: 3, name: "Protester", img: "/escape/sverigeshistoria/protester.jpg", "type": "letters", "answer": "LRKHP", instruction: "Bra jobbat! Ta ledtråd 10" },
       { id: 4, name: "Stockholm", img: "/escape/sverigeshistoria/stockholm.jpg", "type": "symbols", "allowedSymbols": ["circle", "square", "triangle", "heart", "hexagon", "rectangle"], "answerSequence": ["triangle", "hexagon", "circle"], instruction: "Bra jobbat! Ta ledtråd 4" },
       ...
       { id: 6, name: "Pestbyn", img: "/escape/sverigeshistoria/pestbyn.jpg", "type": "colors", "allowedColors": ["yellow", "green", "orange", "red", "pink", "blue"], "answerSequence": ["blue", "red", "green", "yellow"], instruction: "Bra jobbat! Ta ledtråd 5" },
